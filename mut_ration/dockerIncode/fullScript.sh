...
do
    ...
    bwa_index=/genome/$1 #/genome/mm9_only_chromosome.fa
...
# remove duplication
    ...
    in_bam=/scratch/alignment/${sample}sort_rmdup.bam
    out_bam_index=/scratch/alignment/${sample}sort_rmdup.bam.bai

    samtools index -@ 10 ${in_bam} ${out_bam_index}
    mkdir /scratch/pmat_and_mpmat
    in_bam=/scratch/alignment/${sample}sort_rmdup.bam
    ref_genome_fa=/genome/$1 #/genome/mm9_only_chromosome.fa
